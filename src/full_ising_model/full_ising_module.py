...
class IsingEnergyFunction(Function):
    ...
    Backward propagates gradients to gamma and thetas (envelope theorem:
    dE0/dGamma_ij = s*_i s*_j, dE0/dtheta_i = s*_i).
    """
    ...
    def backward(ctx, grad_energies_bulk: torch.Tensor):
        ...
        grad_thetas = grad_energies_bulk.view(batch_size, 1) * configurations_bulk

        return grad_thetas, grad_gamma, None, None
